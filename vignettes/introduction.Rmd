...
In Seurat v5, a new Assay type was introduced called Assay5. Users can switch between using the Assay and Assay5 classes to store counts data by setting the global option `Seurat.object.assay.version` to either "v3" or "v5". Similarly, in `pixelatorR`, you can set the same global option to control whether to use the CellGraphAssay/PNAAssay or CellGraphAssay5/PNAAssay5 class. 
