...
globalVariables(
  names = c(
    ...
    "marker_1", "marker_2", "marker_x", "marker_y", "marker1", "marker2",
    "med_ref", "med_tgt", "mixture_component", "modality", "molecules",
    "morans_z", "n", "n_cells", "n_cells_detected", "n_cells_missing",
    "n_edges", "n_inside", "n_nodes", "n_ref", "n_tgt", "name", "neighbor",
    "node_type", "node_val", "nodes", "norm_factor", "nties", "nties_const",
    "original_id", "p", "p_adj", "p_val", "p_val_adj", "p.value",
    "p1", "p2", "patch", "pct.1", "pct.2", "pearson_z", "png", "pxl_file",
    "quadrant", "r", "read_count", "reads", "receiver_freq", "receiver_unmixed_freq",
    ...
    "umi_count", "umi_per_upia", "umi1", "umi2", "upia", "upia1",
    "upia2", "upib", "val", "value", "value_x", "value_y", "vjust",
    "x", "x_label", "xmax", "xmin", "y", "y_label", "ymax", "ymin",
    "z"
  ),
  package = "pixelatorR",
  add = TRUE
