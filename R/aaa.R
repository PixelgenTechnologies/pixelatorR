...
globalVariables(
  names = c(
    ".", ".x", "bi_prob", "color", "community", "comp", "component",
    "component_new", "componentId", "count_1", "count_2", "current_id",
    "degree", "dens", "dev_png", "doublet_nn_rate", "doublet_nns",
    "doublet_p", "doublet_p_adj", "edge", "edges", "f1", "f2", "frac",
    "frequency", "from", "g", "graph_edges", "graph_projection",
    ...
    "n_inside", "n_nodes", "n_ref", "n_tgt", "name", "neighbor",
    "node_type", "node_val", "nodes", "norm_factor", "nties", "nties_const",
    "original_id", "p", "p_adj", "p_val", "p_val_adj", "p.value",
    "p1", "p2", "pair", "patch", "pct.1", "pct.2", "pearson_z", "png",
    "pxl_file", "quadrant", "r", "read_count", "reads", "reads_in_component",
    "receiver_freq", "receiver_unmixed_freq", "ref_n", "rn", "rs_ref",
    "rs_tgt", "sigma", "simulated", "size", "target_freq", "target_n",
    ...
    "umi_low", "umi_per_upia", "umi1", "umi2", "upia", "upia1", "upia2",
    "upib", "val", "value", "value_x", "value_y", "vjust", "weight",
    "x", "x_label", "xmax", "xmin", "y", "y_label", "y_position",
    "ymax", "ymin", "z"
  ),
  package = "pixelatorR",
  add = TRUE
