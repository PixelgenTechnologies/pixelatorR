...
globalVariables(
  names = c(
    ".", ".x", "bi_prob", "cell_count", "color", "community", "comp", 
    "component", "component_new", "componentId", "count_1", "count_2", 
    "current_id", "degree", "dens", "dev_png", "doublet_nn_rate", 
    "doublet_nns", "doublet_p", "doublet_p_adj", "edge", "edges", 
    "f1", "f2", "frac", "frequency", "from", "g", "graph_edges", 
    "graph_projection", "graph_proteins", "graph_reads", "group", 
    "hjust", "hp", "hue", "hup", "i1", "i2", "id", "id_map", "in_gate", 
    "index", "item", "join_count", "join_count_expected_mean", "join_count_expected_mean_list", 
    "join_count_list", "label", "label_text", "layout", "lbl", "level", 
    "marker", "marker_1", "marker_1_unordered", "marker_2", "marker_2_unordered", 
    "marker_x", "marker_y", "marker1", "marker2", "med_ref", "med_tgt", 
    "min_n_obs", "mixture_component", "modality", "molecules", "morans_z", 
    "n", "n_cells", "n_cells_detected", "n_cells_missing", "n_edges", 
    "n_groups", "n_inside", "n_nodes", "n_ref", "n_tgt", "name", 
    "neighbor", "node_type", "node_val", "nodes", "norm_factor", 
    "nties", "nties_const", "original_id", "p", "p_adj", "p_val", 
    "p_val_adj", "p.value", "p1", "p2", "pair", "patch", "pct.1", 
    "pct.2", "pearson_z", "png", "pxl_file", "quadrant", "r", "read_count", 
    "reads", "reads_in_component", "receiver_freq", "receiver_unmixed_freq", 
    "ref_n", "ref_present", "rn", "rs_ref", "rs_tgt", "sigma", "simulated", 
    "size", "target_freq", "target_n", "target_unmixed_freq", "tau", 
    "tau_type", "text_color", "theoretical_max_edges", "theoretical_max_nodes", 
    "to", "total", "tp", "trial", "tup", "type", "u", "uei_count", 
    "umi_category", "umi_count", "umi_high", "umi_low", "umi_per_upia", 
    "umi1", "umi2", "upia", "upia1", "upia2", "upib", "val", "value", 
    "value_x", "value_y", "vjust", "weight", "x", "x_label", "xmax", 
    "xmin", "y", "y_label", "y_position", "ymax", "ymin", "z"
  ),
  package = "pixelatorR",
  add = TRUE
)
