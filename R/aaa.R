...
globalVariables(
  names = c(
    ...
    "count_1", "count_2", "current_id", "dens", "dev_png", "doublet_nn_rate",
    "doublet_nns", "doublet_p", "doublet_p_adj", "edge", "frequency",
    "from", "g", "graph_edges", "graph_projection", "graph_proteins",
    "graph_reads", "group", "hjust", "hp", "hup", "i1", "i2", "id",
    "id_map", "in_gate", "index", "item", "join_count", "join_count_expected_mean",
    "join_count_expected_mean_list", "join_count_list", "label",
    "layout", "marker", "marker_1", "marker_2", "marker_x", "marker_y",
    "marker1", "marker2", "med_ref", "med_tgt", "mixture_component",
    "modality", "molecules", "morans_z", "n", "n_cells", "n_cells_detected",
    "n_cells_missing", "n_inside", "n_ref", "n_tgt", "name", "neighbor",
    ...
    "quadrant", "r", "read_count", "receiver_freq", "receiver_unmixed_freq",
