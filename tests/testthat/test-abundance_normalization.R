...
test_that("NormalizeMPX works as expected", {
  ...
  expect_equal(head(LayerData(norm_data_clr)),
               new("dgCMatrix", i = c(0L, 1L, 2L, 3L, 4L, 5L, 0L, 1L, 2L, 3L, 
4L, 5L, 0L, 1L, 2L, 3L, 4L, 5L, 0L, 1L, 2L, 3L, 4L, 5L, 0L, 1L, 
2L, 3L, 4L, 5L), p = c(0L, 6L, 12L, 18L, 24L, 30L), Dim = 6:5, 
    Dimnames = list(c("CD274", "CD44", "CD25", "CD279", "CD41", 
    "HLA-ABC"), c("RCVCMP0000217", "RCVCMP0000118", "RCVCMP0000487", 
    "RCVCMP0000655", "RCVCMP0000263")), x = c(-0.0899921902406002, 
...
2L, 3L, 4L, 5L), p = c(0L, 6L, 12L, 18L, 24L, 30L), Dim = 6:5, 
    Dimnames = list(c("CD274", "CD44", "CD25", "CD279", "CD41", 
    "HLA-ABC"), c("RCVCMP0000217", "RCVCMP0000118", "RCVCMP0000487", 
    "RCVCMP0000655", "RCVCMP0000263")), x = c(0.583158270809046, 
    ...
    0.383868338140238, 0.711121074357595), factors = list())
  )
