...
test_that("PredictDoublets works as expected", {
  ...
  set.seed(1)
  expect_equal(
    SimulateDoublets(sim_data, n_sim = 2),
    new("dgCMatrix",
      i = c(
      ...
      x = c(
        ...
        22.7274280516269, 97.7250280221664, 14.3866787100948
      ), factors = list()
    )
  )
  set.seed(1)
  expect_equal(
    SimulateDoublets(sim_data, n_sim = 2, return_id = TRUE),
    list(
      counts = new("dgCMatrix",
        ...
        x = c(
          0.892377550966689, 1.9919700963907, 8.19334019906415,
